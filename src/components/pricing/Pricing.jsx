  ...
  return (
    <div id="pricing">
      ...
      {isHid ? (
        ...
        <h2 className="poppins budget__subHeading">
          My monthly ad spend is up to <span>${Math.ceil(2583.33*value*value*value - 13250*value*value + 27166.67*value - 12000)}</span>
        </h2>
      )}
      <div className="slider-container1">
        ...
        <div
          ...
          style={{
            background: `linear-gradient(to right, blue ${value * 20
              }%, #e0e0e0 ${value * 20}%)`,
          }}
        ></div>
