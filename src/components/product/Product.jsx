...
function Product() {
  ...
  <div className="scroll">
    ...
    >
      <h2 className="poppins whyChoose__cardHeadingAnimation">Instant Account Top-Up</h2>
    ...
    >
      <h2 className="poppins whyChoose__cardHeadingAnimation">Advanced Analytics Dashboard</h2>
      <p className="poppins whyChoose__cardSubHeading">
    ...
    <div
      ...
      style={{ "--visible-y": 0, "--viewport-y": -1 }}
    >
      <h2 className="poppins whyChoose__cardHeadingAnimation">Expert Marketing Guidance</h2>
      <p className="poppins whyChoose__cardSubHeading">
    ...
    <div
      ...
      style={{ "--visible-y": 0, "--viewport-y": -1 }}
    >
      <h2 className="poppins whyChoose__cardHeadingAnimation">Transparent and Economical Pricing</h2>
      <p className="poppins whyChoose__cardSubHeading">
    ...
    <div
      ...
      style={{ "--visible-y": 0, "--viewport-y": -1 }}
    >
      <h2 className="poppins whyChoose__cardHeadingAnimation">Professional and Recognized Partner</h2>
      <p className="poppins whyChoose__cardSubHeading">
